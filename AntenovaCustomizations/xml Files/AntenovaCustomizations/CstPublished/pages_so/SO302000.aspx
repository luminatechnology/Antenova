...
<asp:Content ID="cont2" ContentPlaceHolderID="phF" runat="Server">
    <px:PXFormView ID="form" runat="server" DataSourceID="ds" Style="z-index: 100" Width="100%" DataMember="Document" Caption="Shipment Summary" NoteIndicator="True" FilesIndicator="True" LinkIndicator="true"
        ...
        <Template>
            ...
            <px:PXSelector runat="server" ID="CstPXTextEdit3" DataField="UsrCarrierPluginID" DisplayMode="Text" />
            <px:PXTextEdit runat="server" ID="CstPXTextEdit4" DataField="UsrWaybill" />
            ...
            <px:PXTextEdit runat="server" ID="CstPXTextEdit6" DataField="UsrNote" TextMode="MultiLine" SuppressLabel="True" Height="150px" />
        </Template>
    </px:PXFormView>
</asp:Content>
        ...
        <Items>
            ...
            <px:PXTabItem Text="Packages">
                <Template>
                    ...
                    <px:PXGrid ID="gridPackageDetailSplit" runat="server" SyncPosition="True" SkinID="DetailsInTab" Caption="Contents of Selected Package" Width="100%" Visible="False">
                        <Mode InitNewRow="True" />
